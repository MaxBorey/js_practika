...
// 3----
// Number(prompt('Ваше число:'))=== 10 ? alert('Вірно') : alert('Невірно');

// 4----
// alert (Number(prompt('Ваше число:'))=== 10 ? 'Вірно' : 'Невірно');
...
// } else { alert(`${min} - Ваше число входить в 4 чверть`)};
